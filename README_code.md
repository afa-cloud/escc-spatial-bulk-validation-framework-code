...
These scripts reproduce the public-data analysis tables used by the manuscript. The public code package contains analysis code only; administrative submission files and local utility scripts are not included.
...
The workflow uses public data only and records reproducibility checks in output tables.
